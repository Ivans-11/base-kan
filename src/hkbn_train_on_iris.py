# train HybridKANbyNet on Iris dataset
import torch
...
h_epoch_losses, h_epoch_time = train(model, train_loader, num_epochs=num_epochs, save=True, model_name='HybridKANbyNet_iris')
